<template> 
  <div id="controlscontainer">
    ...
    <br><br>
    <b-button v-on:click="moveSliderLeft()" :disabled="!connected || buttonState === 'links' || !amIActive"><b-icon icon="chevron-left" variant="success"></b-icon> links</b-button>
    ...
    <b-button v-on:click="moveSliderRight()" :disabled="!connected || buttonState === 'rechts' || !amIActive">rechts <b-icon icon="chevron-right" variant="success"></b-icon></b-button>
  </div>
  <div class="half">
  ...
  components: {
        ...
        methods: {
            ...
            moveSliderLeft: function () {
                ...
                <div class="slider-car" style = "right: 2px"></div>
            },
